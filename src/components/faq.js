          ...
          <div className="bg-gradient-to-r w-[100%] from-gray-400 via-gray-600 to-blue-800 ">
            <div>
              <div className=" opacity-75 relative top-32  ">
                <svg
                  className="w-1/2 max-w-screen-sm mx-auto"
                ...
                <section className="text-gray-700">
                  <div className="container px-5 py-24 mx-auto">
                    <div className="text-center mb-20">
                      <h1 className="sm:text-3xl text-2xl font-medium text-center title-font mt-10 text-gray-900 mb-4">
                        Frequently Asked Question
                      </h1>
                      <p className="text-base leading-relaxed text-white xl:w-2/4 lg:w-3/4 mx-auto">
                        The most common questions about how our business works
                    ...
                    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                      <div className="w-full lg:w-1/2 px-4 py-2">
                        <details className="mb-4">
                          ...
                          <span className="text-white ">
                            ...
                            So we are not sure how long this site will be live.
                          </span>
                        </details>
                        <details className="mb-4">
                          <summary className="font-semibold bg-gray-200 rounded-md py-2 px-4">
                            Can I share anything I want?
                          </summary>
                          <span className="text-white ">
                            Yes you can share anything you want. We are open to
                            any ideas you have.
                          </span>
                        </details>
                        <details className="mb-4">
                          <summary className="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                            How is this site diffrent from other files sharing
                            sites?
                          </summary>
                          <span className="text-white ">
                            Unlike other site which are centralize we are fully
                            decentralized
                          </span>
                        </details>
                      </div>
                      <div className="w-full lg:w-1/2 px-4 py-2">
                        <details className="mb-4">
                          <summary className="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                            Where is my files stored?
                          </summary>
                          <span className="px-4 py-2 text-white ">
                            Yours files are stored in decentralize server with
                            IPFS.
                          </span>
                        </details>
                        <details className="mb-4">
                          ...
                          <span className="px-4 py-2 text-white ">
                            The easiest way is to use our web application.
                          </span>
                        </details>
                        <details className="mb-4">
                          <summary className="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                            Will I be able to download files?
                          </summary>
                          <span className="px-4 py-2 text-white ">
                            Yes you can download files.
                          </span>
                        </details>
                      </div>
                    </div>

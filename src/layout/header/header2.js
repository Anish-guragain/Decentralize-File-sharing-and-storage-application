...
class Header2 extends React.Component {
  render() {
    return(
      ...
      <nav className="flex flex-wrap sm:sticky sm:top-0 sticky bottom-0   sm:flex sm:flex-col px-4 py-8 h-fit sm:h-screen  sm:w-fit sm:justify-start justify-between z-10 bg-gray-800">
        <div>
